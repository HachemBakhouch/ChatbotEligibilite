...
class BannedWordsFilter:
    ...
    def __init__(self, banned_words_file=None, max_violations=2):
        ...
        self.banned_words = [
            ...
            "3nf0!r@2!",
            "3nf0!r3x!",
            # Termes originaux et variations de "fuck"
            "fuck",
            "f*ck",
            "f@ck",
            "fuk",
            ...
            "fvk",
            "fück",
            # Termes originaux et variations de "enfoiré"
            "enfoiré",
            "enfoirés",
            "enfoirée",
            "3nfoiré",
